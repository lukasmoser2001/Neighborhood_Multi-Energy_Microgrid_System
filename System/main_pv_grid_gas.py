...
def apply_component_parameters(config: dict) -> dict:
    ...
    - beta_per_c: per °C, temperature coefficient (0.24 %/°C → 0.0024 /°C)
    - panel_area_m2: m², area per panel
    - panels_per_household: number of panels per household (6 panels ≈ 2820 Wp)
    - power_density_w_m2: W/m², Power density PV panel
    - annualized_capital_cost_per_panel_eur: €/year, annualized capital cost per panel including interest
    - o_and_m_cost_per_kwh_eur: €/kWh, operation & maintenance cost per kWh generated
    ...
    - efficiency: dimensionless, conversion efficiency from electricity to heat
    - lcoh_eur_per_kwh: €/kWh, levelized cost of heat
